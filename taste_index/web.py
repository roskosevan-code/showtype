...
<body>
<header><div class="hrow"><h1>The Taste Index</h1><span class="hcount" id="count"></span></div></header>
<nav>
...
function setTab(id){
  ...
  localStorage.setItem('ti-tab',id);
